...
if (m.money) m.reply(+m.money + ` X~KWCoins ${await tr("usados")} 🪙`) 
}
break
}}} catch (e) {
console.error(e)
...
if (!m.fromMem && m.text.match(/(@249967185716|@249967185716|مافيا|بوت|احمد|بحبك|اخويا|و|او|😂|🙂|😹|♥️|🔥|❤️|💘|💕|🙈|🥂|🍯|🍺|يسطا|ملف|كود|جنية|منصة|اسكربت|ولد|بنت|بوتي|مطور|هه|ههه|ههههه|هههههه|خخخخ|خخخخخ|كسمك|شرموط|اكل|هاي|باي|مساء|صباح|السلام|سلام|الحمد|الله|الجروب|جروب|صورة|اسم|تست|1|2|3|4|5|6|7|8|9|0|:v)/gi)) {
...
if (nk.isGroup == false) {
if (nk.status == "offer") {
let callmsg = await this.reply(nk.from, `مرحبا *@${nk.from.split('@')[0]}*, يمنع ${nk.isVideo ? 'مكالمات الفيديو' : 'المكالمات'} في البوت لذا سوف اقوم بحظرك لانك اتصلت به.\n\nلو تريد البوت يمكنك استخدامه في الجروبات\n\nرقم المطور لفك الحظر عنك: wa.me/201208076133`, false, { mentions: [nk.from] })
let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝐌𝐀𝐅𝐈𝐀 👑;;;\nFN:𝙇𝙤𝙡𝙞𝘽𝙤𝙩-𝙈𝘿\nORG:𝐌𝐀𝐅𝐈𝐀-𝐁𝐎𝐓 👑\nTITLE:\nitem1.TEL;waid=201208076133:+201208076133\nitem1.X-ABLabel:𝐌𝐀𝐅𝐈𝐀 👑\nX-WA-BIZ-DESCRIPTION:[❗] رقم مطور البوت.\nX-WA-BIZ-NAME:𝐌𝐀𝐅𝐈𝐀 👑\nEND:VCARD`
await this.sendMessage(nk.from, { contacts: { displayName: '𝐌𝐀𝐅𝐈𝐀 👑', contacts: [{ vcard }] }}, {quoted: callmsg})
...
if (msg) return conn.sendMessage(m.chat, {text: msg, contextInfo: { mentionedJid: null, forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363400740835292@newsletter', serverMessageId: '', newsletterName: 'mafia' }, externalAdReply : {mediaUrl: null, mediaType: 1, description: null, "title": `ℹ️𝐈𝐍𝐅𝐎 ℹ️`, body: wm, previewType: 0, "thumbnail": img.getRandom(), sourceUrl: [nna, nna2, md, yt, nn, tiktok].getRandom()}}}, { quoted: m })
}
