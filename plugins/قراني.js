...
conn.sendFile(m.chat, url, 'error.jpg', ` استمتع بࢪاحـه نفسـيه`, m)
//conn.sendButton(m.chat, `استمتع بࢪاحـه نفسـيه`, author, url, [['اضــــــغـط للمـزيـد', `/${command}`]], null, null, m)
}
handler.help = ['قران']
handler.tags = ['internet']
handler.command = /^(قراني)$/
handler.exp = 50
handler.level = 0
