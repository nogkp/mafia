...
let fakegif = { key: {participant: `0@s.whatsapp.net`, ...("6289643739077-1613049930@g.us" ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title": '𝑩𝑶𝑻-𝑴𝑨𝑭𝑰𝑨 - MD❄️✰', "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': '🐱𝑩𝑶𝑻-𝑴𝑨𝑭𝑰𝑨❄️⃨፝⃕✰', 'jpegThumbnail': false }}}
